...
@section('content')
    @section('content1')
        <a href="/dashboard/categories/" class="text-muted text-hover-primary">Categories /</a>
    @endsection
    <h2>Categories</h2>
    <link rel="icon" type="image/x-icon" href="/logo.png">
    <a href="/dashboard/categories/create" style="margin-bottom:20px;" class="btn btn-primary"> <i
        ...
        <script type="text/javascript">
            $(function() {
                var table = $('#data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('dashboard.categories') }}",
                    columns: [{
                        data: 'id',
                        name: 'id'
                    },
