...
@section('content')
    @section('content1')
        ...
        <a href="/dashboard/suppliers/create/" class="text-muted text-hover-primary">  Create <span style="color: black"> / </span></a>
    @endsection
    <div class="container">
        {{-- validation --}}
        @if ($errors->any())
        ...
        @endif
        <form class="form" action="/dashboard/suppliers" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
