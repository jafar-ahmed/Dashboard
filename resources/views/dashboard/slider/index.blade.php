...
@section('content')
    @section('content1')
        <a href="/dashboard/slider/" class="text-muted text-hover-primary">Sliders /</a>
    @endsection
     <h2>Sliders</h2>
     <link rel="icon" type="image/x-icon" href="/logo.png">
     <a href="/dashboard/slider/create" style="margin-bottom:20px;" class="btn btn-primary"> <i
...
{{--                    @dd('sgd')--}}
                    ...
                    Swal.fire({
                        ...
                        if (result) {
                            $.ajax({
                                 url: "/dashboard/slider/deleteImage/" + id,
                                {{--url: "{{ route('dashboard.slider.deleteImage') }}",--}}
                                {{--data: {--}}
                                {{--    id: id,--}}
                                {{--},--}}
