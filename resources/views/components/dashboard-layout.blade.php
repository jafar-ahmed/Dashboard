...
{{--                                    href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">--}}
...
{{--                                <!--end::Icon-->--}}
{{--                                <!--begin::Icon-->--}}
{{--                                <a class="btn btn-sm btn-icon btn-circle btn-icon-danger btn-active-light-danger"--}}
{{--                                    href="#" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"--}}
...
{{--                                        data-bs-toggle="tab" href="#kt_lists_widget_3_tab_pane_1">Exclusive--}}
{{--                                        Authors</a>--}}
{{--                                </li>--}}
{{--                                <!--end::Tab nav-->--}}
{{--                                <!--begin::Tab nav-->--}}
...
{{--                                                        Aerostar</a>--}}
{{--                                                    <div class="fw-bold fs-6 text-gray-400">iper-aircraft-class.jsp--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <!--end::List content-->--}}
{{--                                                <!--begin::Price-->--}}
...
{{--                                                <!--begin::Avatar-->--}}
{{--                                                <div class="symbol symbol-40px symbol-circle me-4">--}}
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-3.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::List content-->--}}
{{--                                                <div class="d-flex flex-column min-w-150px me-4">--}}
...
{{--                                                <!--begin::Avatar-->--}}
{{--                                                <div class="symbol symbol-40px symbol-circle me-4">--}}
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-7.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::List content-->--}}
{{--                                                <div class="d-flex flex-column min-w-150px me-4">--}}
...
{{--                                                        SF150</a>--}}
{{--                                                    <div class="fw-bold fs-6 text-gray-400">cessna-aircraft-class.jsp--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <!--end::List content-->--}}
{{--                                                <!--begin::Price-->--}}
...
{{--                                                <div class="symbol symbol-40px symbol-circle me-4">--}}
{{--                                                    <span--}}
{{--                                                        class="symbol-label bg-light-danger text-danger fw-boldest">T</span>--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::List content-->--}}
{{--                                                <div class="d-flex flex-column min-w-150px me-4">--}}
...
{{--                                                <div class="symbol symbol-40px symbol-circle me-4">--}}
{{--                                                    <span--}}
{{--                                                        class="symbol-label bg-light-info text-info fw-boldest">R</span>--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::List content-->--}}
{{--                                                <div class="d-flex flex-column min-w-150px me-4">--}}
...
{{--                                                <!--begin::Avatar-->--}}
{{--                                                <div class="symbol symbol-40px symbol-circle me-4">--}}
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-5.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::List content-->--}}
{{--                                                <div class="d-flex flex-column min-w-150px me-4">--}}
{{--                                                    <a href="#"--}}
{{--                                                        class="fw-boldest text-gray-800 text-hover-primary fs-4">Space--}}
{{--                                                        Jump</a>--}}
...
{{--                                                <!--begin::Avatar-->--}}
{{--                                                <div class="symbol symbol-40px symbol-circle me-4">--}}
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-12.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::List content-->--}}
{{--                                                <div class="d-flex flex-column min-w-150px me-4">--}}
...
{{--                                                    <img src="d_assets/media/svg/brand-logos/plurk.svg"--}}
...
{{--                                            <div class="symbol symbol-50px symbol-circle me-5">--}}
{{--                                                <span class="symbol-label">--}}
{{--                                                    <img src="d_assets/media/svg/brand-logos/telegram.svg"--}}
{{--                                                        class="h-50 align-self-center" alt="" />--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
...
{{--                                            <div class="symbol symbol-50px symbol-circle me-5">--}}
{{--                                                <span class="symbol-label">--}}
{{--                                                    <img src="d_assets/media/svg/brand-logos/vimeo.svg"--}}
{{--                                                        class="h-50 align-self-center" alt="" />--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
...
{{--                                            <div class="symbol symbol-50px symbol-circle me-5">--}}
{{--                                                <span class="symbol-label">--}}
{{--                                                    <img src="d_assets/media/svg/brand-logos/treva.svg"--}}
{{--                                                        class="h-50 align-self-center" alt="" />--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
...
{{--                                                        Themes</a>--}}
{{--                                                    <span class="text-muted fw-bold d-block fs-7">Alex, Kate,--}}
{{--                                                        Dave</span>--}}
{{--                                                </div>--}}
...
{{--                                            <div class="symbol symbol-50px symbol-circle me-5">--}}
{{--                                                <span class="symbol-label">--}}
{{--                                                    <img src="d_assets/media/svg/brand-logos/bebo.svg"--}}
{{--                                                        class="h-50 align-self-center" alt="" />--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
...
{{--                                            <div class="symbol symbol-50px symbol-circle me-5">--}}
{{--                                                <span class="symbol-label">--}}
{{--                                                    <img src="d_assets/media/svg/brand-logos/kickstarter.svg"--}}
{{--                                                        class="h-50 align-self-center" alt="" />--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
...
{{--                                            <div class="symbol symbol-50px symbol-circle me-5">--}}
{{--                                                <span class="symbol-label">--}}
{{--                                                    <img src="d_assets/media/svg/brand-logos/fox-hub.svg"--}}
{{--                                                        class="h-50 align-self-center" alt="" />--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
...
{{--                                                <a href=""--}}
{{--                                                    class="fs-2 text-gray-800 text-hover-primary fw-boldest">Rider--}}
{{--                                                    Admin Launch Day</a>--}}
{{--                                                <p class="text-gray-600 fs-6 fw-bold pt-4 mb-0">To start a blog, think--}}
{{--                                                    of a topic about and first brainstorm ways to write details</p>--}}
{{--                                            </div>--}}
{{--                                            <!--begin::Info-->--}}
{{--                                            <div class="d-flex flex-stack pt-8">--}}
{{--                                                <span class="badge badge-light-primary fs-7 fw-boldest me-2">OCT 05,--}}
{{--                                                    10</span>--}}
{{--                                                <a href="#"--}}
{{--                                                    class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5"--}}
{{--                                                    data-bs-toggle="modal"--}}
{{--                                                    data-bs-target="#kt_modal_create_account">Join</a>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Info-->--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                            <!--begin::Info-->--}}
{{--                                            <div class="d-flex flex-stack pt-8">--}}
{{--                                                <span class="badge badge-light-primary fs-7 fw-boldest me-2">DEC 03,--}}
{{--                                                    20</span>--}}
{{--                                                <a href="#"--}}
{{--                                                    class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5"--}}
{{--                                                    data-bs-toggle="modal"--}}
...
{{--                                            <!--begin::Info-->--}}
{{--                                            <div class="d-flex flex-stack pt-8">--}}
{{--                                                <span class="badge badge-light-primary fs-7 fw-boldest me-2">NOV 06,--}}
{{--                                                    23</span>--}}
{{--                                                <a href="#"--}}
{{--                                                    class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5"--}}
{{--                                                    data-bs-toggle="modal"--}}
...
{{--                                            <!--begin::Info-->--}}
{{--                                            <div class="d-flex flex-stack pt-8">--}}
{{--                                                <span class="badge badge-light-primary fs-7 fw-boldest me-2">AUG 01,--}}
{{--                                                    13</span>--}}
{{--                                                <a href="#"--}}
{{--                                                    class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5"--}}
{{--                                                    data-bs-toggle="modal"--}}
...
{{--                                    <div class="ps-1 mb-1">--}}
{{--                                        <a href="#"--}}
{{--                                            class="fs-5 text-gray-800 text-hover-primary fw-boldest">Project Alice</a>--}}
...
{{--                                    <div class="ps-1 mb-1">--}}
{{--                                        <a href="#"--}}
{{--                                            class="fs-5 text-gray-800 text-hover-primary fw-boldest">Project Rider</a>--}}
...
{{--                                    <div class="ps-1 mb-1">--}}
{{--                                        <a href="#"--}}
{{--                                            class="fs-5 text-gray-800 text-hover-primary fw-boldest">Icon d_assets</a>--}}
...
{{--                                                                        src="d_assets/media/svg/brand-logos/aven.svg" />--}}
{{--                                                                </span>--}}
{{--                                                            </div>--}}
{{--                                                            <!--end::Logo-->--}}
{{--                                                            <div class="ps-3">--}}
...
{{--                                                    <td>--}}
{{--                                                        <span--}}
{{--                                                            class="text-gray-800 fw-boldest fs-5 d-block">Intertico</span>--}}
...
{{--                                                                <span class="symbol-label">--}}
{{--                                                                    <img alt="" class="w-25px"--}}
{{--                                                                        src="d_assets/media/svg/brand-logos/leaf.svg" />--}}
{{--                                                                </span>--}}
{{--                                                            </div>--}}
{{--                                                            <!--end::Logo-->--}}
{{--                                                            <div class="ps-3">--}}
...
{{--                                                                    Clarcson</a>--}}
{{--                                                                <span class="text-gray-400 fw-bold d-block">C#,--}}
{{--                                                                    ASP.NET, MS SQL</span>--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                    </td>--}}
...
{{--                                                    <td>--}}
{{--                                                        <span--}}
{{--                                                            class="text-gray-800 fw-boldest fs-5 d-block">Agoda</span>--}}
...
{{--                                                                <span class="symbol-label">--}}
{{--                                                                    <img alt="" class="w-25px"--}}
{{--                                                                        src="d_assets/media/svg/brand-logos/atica.svg" />--}}
{{--                                                                </span>--}}
{{--                                                            </div>--}}
{{--                                                            <!--end::Logo-->--}}
{{--                                                            <div class="ps-3">--}}
...
{{--                                                    <td>--}}
{{--                                                        <span--}}
{{--                                                            class="text-gray-800 fw-boldest fs-5 d-block">RoadGee</span>--}}
...
{{--                                                                <span class="symbol-label">--}}
{{--                                                                    <img alt="" class="w-25px"--}}
{{--                                                                        src="d_assets/media/svg/brand-logos/volicity-9.svg" />--}}
{{--                                                                </span>--}}
{{--                                                            </div>--}}
{{--                                                            <!--end::Logo-->--}}
{{--                                                            <div class="ps-3">--}}
...
{{--                                                    <!--begin::Company=-->--}}
{{--                                                    <td>--}}
{{--                                                        <span class="text-gray-800 fw-boldest fs-5 d-block">The--}}
{{--                                                            Hill</span>--}}
...
{{--                                            <img src="d_assets/media/stock/600x400/img-17.jpg" class="mw-100"--}}
{{--                                                alt="" />--}}
{{--                                        </div>--}}
{{--                                        <!--end::Symbol-->--}}
{{--                                        <!--begin::Section-->--}}
...
{{--                                                <a href="#"--}}
{{--                                                    class="fs-5 text-gray-800 text-hover-primary fw-boldest">Cup &amp;--}}
{{--                                                    Green</a>--}}
...
{{--                                        <!--begin::Symbol-->--}}
{{--                                        <div class="symbol symbol-60px symbol-2by3 me-4">--}}
{{--                                            <img src="d_assets/media/stock/600x400/img-10.jpg" class="mw-100"--}}
{{--                                                alt="" />--}}
{{--                                        </div>--}}
{{--                                        <!--end::Symbol-->--}}
{{--                                        <!--begin::Section-->--}}
...
{{--                                            <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">--}}
{{--                                                <a href="#"--}}
{{--                                                    class="fs-5 text-gray-800 text-hover-primary fw-boldest">Yellow--}}
{{--                                                    Hearts</a>--}}
{{--                                                <span class="text-gray-400 fw-bold fs-7 my-1">Study highway--}}
{{--                                                    types</span>--}}
{{--                                                <span class="text-gray-400 fw-bold fs-7">By:--}}
...
{{--                                        <!--begin::Symbol-->--}}
{{--                                        <div class="symbol symbol-60px symbol-2by3 me-4">--}}
{{--                                            <img src="d_assets/media/stock/600x400/img-1.jpg" class="mw-100"--}}
{{--                                                alt="" />--}}
{{--                                        </div>--}}
{{--                                        <!--end::Symbol-->--}}
{{--                                        <!--begin::Section-->--}}
...
{{--                                        <!--begin::Symbol-->--}}
{{--                                        <div class="symbol symbol-60px symbol-2by3 me-4">--}}
{{--                                            <img src="d_assets/media/stock/600x400/img-9.jpg" class="mw-100"--}}
{{--                                                alt="" />--}}
{{--                                        </div>--}}
{{--                                        <!--end::Symbol-->--}}
{{--                                        <!--begin::Section-->--}}
...
{{--                                            <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">--}}
{{--                                                <a href="#"--}}
{{--                                                    class="fs-5 text-gray-800 text-hover-primary fw-boldest">Red--}}
{{--                                                    Boots</a>--}}
{{--                                                <span class="text-gray-400 fw-bold fs-7 my-1">Study highway--}}
{{--                                                    types</span>--}}
{{--                                                <span class="text-gray-400 fw-bold fs-7">By:--}}
...
{{--                                                <img src="d_assets/media/avatars/150-3.jpg" alt="" />--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
{{--                                            <!--begin::Title-->--}}
{{--                                            <div class="ps-1">--}}
{{--                                                <a href="#"--}}
{{--                                                    class="fs-6 text-gray-800 text-hover-primary fw-boldest">Anne--}}
{{--                                                    Clarc</a>--}}
...
{{--                                            <!--begin::Symbol-->--}}
{{--                                            <div class="symbol symbol-circle symbol-40px me-4">--}}
{{--                                                <img src="d_assets/media/avatars/150-2.jpg" alt="" />--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
{{--                                            <!--begin::Title-->--}}
{{--                                            <div class="ps-1">--}}
{{--                                                <a href="#"--}}
{{--                                                    class="fs-6 text-gray-800 text-hover-primary fw-boldest">Brad--}}
{{--                                                    Simmons</a>--}}
...
{{--                                            <!--begin::Symbol-->--}}
{{--                                            <div class="symbol symbol-circle symbol-40px me-4">--}}
{{--                                                <img src="d_assets/media/avatars/150-4.jpg" alt="" />--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
{{--                                            <!--begin::Title-->--}}
{{--                                            <div class="ps-1">--}}
{{--                                                <a href="#"--}}
{{--                                                    class="fs-6 text-gray-800 text-hover-primary fw-boldest">Randy--}}
{{--                                                    Trent</a>--}}
...
{{--                                            <!--begin::Symbol-->--}}
{{--                                            <div class="symbol symbol-circle symbol-40px me-4">--}}
{{--                                                <img src="d_assets/media/avatars/150-5.jpg" alt="" />--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
{{--                                            <!--begin::Title-->--}}
{{--                                            <div class="ps-1">--}}
{{--                                                <a href="#"--}}
{{--                                                    class="fs-6 text-gray-800 text-hover-primary fw-boldest">Ricky--}}
{{--                                                    Hunt</a>--}}
...
{{--                                            <!--begin::Symbol-->--}}
{{--                                            <div class="symbol symbol-circle symbol-40px me-4">--}}
{{--                                                <img src="d_assets/media/avatars/150-6.jpg" alt="" />--}}
{{--                                            </div>--}}
{{--                                            <!--end::Symbol-->--}}
{{--                                            <!--begin::Title-->--}}
{{--                                            <div class="ps-1">--}}
...
{{--                                                            name="account_type" value="personal" checked="checked"--}}
...
{{--                                                                <span--}}
{{--                                                                    class="text-dark fw-bolder d-block fs-4 mb-2">Personal--}}
{{--                                                                    Account</span>--}}
{{--                                                                <span class="text-gray-400 fw-bold fs-6">If you need--}}
...
{{--                                                            <span class="d-block fw-bold text-start">--}}
{{--                                                                <span--}}
{{--                                                                    class="text-dark fw-bolder d-block fs-4 mb-2">Corporate--}}
{{--                                                                    Account</span>--}}
{{--                                                                <span class="text-gray-400 fw-bold fs-6">Create--}}
...
{{--                                                <!--begin::Label-->--}}
{{--                                                <label class="d-flex align-items-center form-label mb-3">Specify Team--}}
{{--                                                    Size--}}
{{--                                                    <i class="fas fa-exclamation-circle ms-2 fs-7"--}}
{{--                                                        data-bs-toggle="tooltip"--}}
...
{{--                                                                    Account</span>--}}
{{--                                                                <span class="fs-6 fw-bold text-gray-400">Use images to--}}
...
{{--                                                        <img src="d_assets/media/svg/card-logos/visa.svg"--}}
{{--                                                            alt="" class="h-25px" />--}}
{{--                                                        <img src="d_assets/media/svg/card-logos/mastercard.svg"--}}
{{--                                                            alt="" class="h-25px" />--}}
{{--                                                        <img src="d_assets/media/svg/card-logos/american-express.svg"--}}
{{--                                                            alt="" class="h-25px" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Card logos-->--}}
{{--                                                </div>--}}
...
{{--                                            <div class="mb-0">--}}
{{--                                                <!--begin::Text-->--}}
{{--                                                <div class="fs-6 text-gray-600 mb-5">Writing headlines for blog posts--}}
{{--                                                    is as much an art as it is a science and probably warrants its own--}}
{{--                                                    post, but for all advise is with what works for your great &amp;--}}
...
{{--                                                        <!--begin::Content-->--}}
{{--                                                        <div class="fw-bold">--}}
{{--                                                            <h4 class="text-gray-800 fw-bolder">We need your--}}
{{--                                                                attention!</h4>--}}
{{--                                                            <div class="fs-6 text-gray-600">To start using great--}}
{{--                                                                tools, please, please--}}
{{--                                                                <a href="#" class="fw-bolder">Create Team--}}
{{--                                                                    Platform</a>--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                        <!--end::Content-->--}}
...
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-1.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::Info-->--}}
{{--                                                <div class="fw-bold">--}}
...
{{--                                                <!--begin::Avatar-->--}}
{{--                                                <div class="symbol symbol-35px symbol-circle me-5">--}}
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-2.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::Info-->--}}
{{--                                                <div class="fw-bold">--}}
...
{{--                                                <!--begin::Avatar-->--}}
{{--                                                <div class="symbol symbol-35px symbol-circle me-5">--}}
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-4.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::Info-->--}}
{{--                                                <div class="fw-bold">--}}
...
{{--                                                <!--begin::Avatar-->--}}
{{--                                                <div class="symbol symbol-35px symbol-circle me-5">--}}
{{--                                                    <img alt="Pic" src="d_assets/media/avatars/150-15.jpg" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Avatar-->--}}
{{--                                                <!--begin::Info-->--}}
{{--                                                <div class="fw-bold">--}}
...
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-1.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-2.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-4.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-15.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-8.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-6.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-7.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-17.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                                    <div class="symbol symbol-35px symbol-circle">--}}
{{--                                                        <img alt="Pic"--}}
{{--                                                            src="d_assets/media/avatars/150-10.jpg" />--}}
{{--                                                    </div>--}}
{{--                                                    <!--end::Avatar-->--}}
{{--                                                    <!--begin::Details-->--}}
{{--                                                    <div class="ms-5">--}}
...
{{--                                            <div class="text-gray-400 fs-6">Try to search by username, full name or--}}
{{--                                                email...</div>--}}
{{--                                        </div>--}}
{{--                                        <!--end::Message-->--}}
{{--                                        <!--begin::Illustration-->--}}
{{--                                        <div class="text-center px-4">--}}
{{--                                            <img src="d_assets/media/illustrations/alert.png" alt=""--}}
...
{{--                                            <img src="d_assets/media/svg/card-logos/visa.svg" alt=""--}}
{{--                                                class="h-25px" />--}}
{{--                                            <img src="d_assets/media/svg/card-logos/mastercard.svg" alt=""--}}
{{--                                                class="h-25px" />--}}
{{--                                            <img src="d_assets/media/svg/card-logos/american-express.svg"--}}
{{--                                                alt="" class="h-25px" />--}}
{{--                                        </div>--}}
